...
- **temporal-fills.jsonl / temporal-mids.jsonl** — 10 two-leg set pairs; flat per-leg-vs-concurrent-
  mid edges read "neutral" (−0.5c/+0.5c) while t1-anchored truth is a planted ~$210 structural loss
  (avg set cost 1.0205 vs 1.00 par). Used for the latent-dimension negative result (see
